...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-6 text-lg md:text-xl text-left font-semibold transition-all hover:text-blue-500 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
